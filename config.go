...
type ConfigFlags struct {
	...
	MinProtoVer uint8  `long:"minprotocolversion" description:"Minimum protocol version for nodes."`
	MinVersion  string `long:"minversion" description:"Minimum version for nodes."`
